...
def main(session_key, settings, features):
    ...
    pack_and_store_data(output_dir, data, waveform_data, audio_duration, audio_path, settings, features)
...
def pack_and_store_data(output_dir, data, waveform_data, audio_duration, audio_path, settings, features):
